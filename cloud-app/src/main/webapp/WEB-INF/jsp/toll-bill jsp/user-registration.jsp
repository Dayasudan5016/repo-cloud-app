...
<html>
    <head>
        ...
        <style>
            .bg {
                background-image: url("https://i.ibb.co/8B7Qt2t/P-20201024-113255.jpg");
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <form class="form-container" method="post">
                        ...
                        <div class="form group">
                            <input type="text" name="firstname" id="first_name" class="form-control" placeholder="Enter your first name" required>
                        </div>
                        <div class="form group">
                            <input type="text" name="lastname" id="last_name" class="form-control" placeholder="Enter your last name" required>
                        </div>
                        <!--<div class="form group">
